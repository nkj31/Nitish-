...
<body>
        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="name" name="name" placeholder="Enter your name(Ex.Nitish)" class="form-control input-md" type="text" value="<?php
                                                                                                                                        if (isset($_GET['name'])) {
                                                                                                                                          echo $_GET['name'];
                                                                                                                                        } ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex.0108CA211015)" class="form-control input-md" type="text" value="<?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="phno" minlength="10" maxlength="10" name="phno" placeholder="Enter your mobile number(8305763637)" class="form-control input-md" type="text" value="" required>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <span class="text-danger" id="cmsg"></span>
              </div>
            </div>
            <div class="form-group">
  ...
  <div class="row footer">
    ...
    <div class="col-md-3 box">
      <span href="#" data-target="#login" style="color:lightyellow">Devloped By : Nitish & Ankit <br>special thanks to Atul😋<br><i>All rights are reaserved<br><i>© 2022<br></span>
    </div>
